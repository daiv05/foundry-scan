    ...
    return {
        "sources": {
            "reddit": {
                "name": "Reddit",
                "status": "ready",
                "method": "Playwright browser - no credentials required",
                "config": {
                    "delay_ms": settings.collector_request_delay_ms,
        ...
        "env_vars": {
            ...
            "COLLECTOR_REQUEST_DELAY_MS": {
                "value": settings.collector_request_delay_ms,
                "default": 2000,
                "description": "Polite delay between page requests in milliseconds. Increase if getting blocked.",
            },
            "REDDIT_FETCH_COMMENTS": {
                "value": settings.reddit_fetch_comments,
                "default": False,
                "description": "Whether to collect post comments (slower, more data).",
            },
        },
        "instructions": {
            "how_to_update": (
